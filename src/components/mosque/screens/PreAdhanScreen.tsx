  ...
  return (
    <div className="min-h-screen bg-islamic flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-8 animate-fade-in-up">
        ...
        <div className="mb-8">
          <svg 
            className="w-20 h-20 mx-auto text-secondary animate-float" 
            viewBox="0 0 24 24" 
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
        ...
        {/* Main text */}
        <h1 className="font-arabic text-4xl md:text-5xl lg:text-6xl text-foreground mb-6">
          اقترب موعد
        </h1>
        
        <h2 className="font-arabic text-5xl md:text-6xl lg:text-7xl text-gradient-gold mb-8">
          أذان {prayer.nameAr}
        </h2>
        ...
        {/* Reminder */}
        <p className="mt-12 font-arabic text-xl text-muted-foreground">
          استعدوا للصلاة
        </p>
      </div>
